context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_winter_supply_h_output_relative_humidity').should('have.text', '36.1');
    cy.get('#calculation_winter_supply_h_output_absolute_humidity').should('have.text', '4.64');
    cy.get('#calculation_winter_supply_h_output_wet_bulb_temperature').should('have.text', '10.16');
    cy.get('#calculation_winter_supply_h_output_enthalpy').should('have.text', '29.7');
    cy.get('#calculation_winter_supply_h_face_air_velocity').should('have.text', '1.06');
    cy.get('#calculation_winter_supply_h_air_pressure_drop').should('have.text', '45.26');
    cy.get('#calculation_winter_supply_h_temperature_efficiency_dry').should('have.text', '83.87');
    cy.get('#calculation_winter_supply_h_temperature_efficiency_wet').should('have.text', '83.87');
    cy.get('#calculation_winter_supply_h_heat_recovery_dry').should('have.text', '0.93');
    cy.get('#calculation_winter_supply_h_heat_recovery_wet').should('have.text', '0.93');
    ...
    cy.get('#calculation_winter_extract_c_output_relative_humidity').should('have.text', '74.75');
    ...
    cy.get('#calculation_winter_extract_c_output_enthalpy').should('have.text', '22.65');
    cy.get('#calculation_winter_extract_c_face_air_velocity').should('have.text', '1.11');
    cy.get('#calculation_winter_extract_c_air_pressure_drop').should('have.text', '47.36');
    cy.get('#calculation_winter_extract_c_temperature_efficiency_dry').should('have.text', '83.87');
    cy.get('#calculation_winter_extract_c_temperature_efficiency_wet').should('have.text', '83.87');
    cy.get('#calculation_winter_extract_c_heat_recovery_dry').should('have.text', '-0.93');
    cy.get('#calculation_winter_extract_c_heat_recovery_wet').should('have.text', '-0.93');
    ...
    cy.get('#calculation_summer_supply_c_output_temperature').should('have.text', '28.32');
    cy.get('#calculation_summer_supply_c_output_relative_humidity').should('have.text', '57.45');
    cy.get('#calculation_summer_supply_c_output_absolute_humidity').should('have.text', '14.14');
    cy.get('#calculation_summer_supply_c_output_wet_bulb_temperature').should('have.text', '21.87');
    cy.get('#calculation_summer_supply_c_output_enthalpy').should('have.text', '64.12');
    cy.get('#calculation_summer_supply_c_face_air_velocity').should('have.text', '1.16');
    cy.get('#calculation_summer_supply_c_air_pressure_drop').should('have.text', '49.79');
    cy.get('#calculation_summer_supply_c_temperature_efficiency_dry').should('have.text', '83.48');
    cy.get('#calculation_summer_supply_c_temperature_efficiency_wet').should('have.text', '83.48');
    cy.get('#calculation_summer_supply_c_heat_recovery_dry').should('have.text', '-0.5');
    cy.get('#calculation_summer_supply_c_heat_recovery_wet').should('have.text', '-0.5');
    ...
    cy.get('#calculation_summer_extract_h_output_airflow').should('have.text', '261.65');
    cy.get('#calculation_summer_extract_h_output_temperature').should('have.text', '33.68');
    cy.get('#calculation_summer_extract_h_output_relative_humidity').should('have.text', '30.93');
    ...
    cy.get('#calculation_summer_extract_h_output_enthalpy').should('have.text', '59.9');
    cy.get('#calculation_summer_extract_h_face_air_velocity').should('have.text', '1.13');
    cy.get('#calculation_summer_extract_h_air_pressure_drop').should('have.text', '48.5');
    cy.get('#calculation_summer_extract_h_temperature_efficiency_dry').should('have.text', '83.48');
    cy.get('#calculation_summer_extract_h_temperature_efficiency_wet').should('have.text', '83.48');
    cy.get('#calculation_summer_extract_h_heat_recovery_dry').should('have.text', '0.5');
    cy.get('#calculation_summer_extract_h_heat_recovery_wet').should('have.text', '0.5');
