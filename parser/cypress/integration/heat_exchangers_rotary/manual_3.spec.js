context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_h_output_airflow').should('have.text', '247.78');
    cy.get('#calculation_h_output_temperature').should('have.text', '18.56');
    cy.get('#calculation_h_output_relative_humidity').should('have.text', '34.62');
    cy.get('#calculation_h_output_absolute_humidity').should('have.text', '4.64');
    cy.get('#calculation_h_output_wet_bulb_temperature').should('have.text', '10.44');
    cy.get('#calculation_h_output_enthalpy').should('have.text', '30.35');
    cy.get('#calculation_h_face_air_velocity').should('have.text', '1.06');
    cy.get('#calculation_h_air_pressure_drop').should('have.text', '46.84');
    cy.get('#calculation_h_temperature_efficiency_dry').should('have.text', '88.89');
    cy.get('#calculation_h_temperature_efficiency_wet').should('have.text', '88.89');
    cy.get('#calculation_h_heat_recovery_dry').should('have.text', '0.97');
    cy.get('#calculation_h_heat_recovery_wet').should('have.text', '0.97');
    ...
    cy.get('#calculation_c_output_airflow').should('have.text', '239.19');
    cy.get('#calculation_c_output_temperature').should('have.text', '8.44');
    cy.get('#calculation_c_output_relative_humidity').should('have.text', '78.17');
    cy.get('#calculation_c_output_absolute_humidity').should('have.text', '5.36');
    cy.get('#calculation_c_output_wet_bulb_temperature').should('have.text', '6.65');
    cy.get('#calculation_c_output_enthalpy').should('have.text', '21.99');
    cy.get('#calculation_c_face_air_velocity').should('have.text', '1.1');
    cy.get('#calculation_c_air_pressure_drop').should('have.text', '49.04');
    cy.get('#calculation_c_temperature_efficiency_dry').should('have.text', '88.89');
    cy.get('#calculation_c_temperature_efficiency_wet').should('have.text', '88.89');
    cy.get('#calculation_c_heat_recovery_dry').should('have.text', '-0.97');
    cy.get('#calculation_c_heat_recovery_wet').should('have.text', '-0.97');
    ...
    cy.get('#calculation_c_output_airflow').should('have.text', '255.74');
    cy.get('#calculation_c_output_temperature').should('have.text', '27.92');
    cy.get('#calculation_c_output_relative_humidity').should('have.text', '58.87');
    ...
    cy.get('#calculation_c_output_enthalpy').should('have.text', '63.74');
    cy.get('#calculation_c_face_air_velocity').should('have.text', '1.16');
    cy.get('#calculation_c_air_pressure_drop').should('have.text', '51.57');
    cy.get('#calculation_c_temperature_efficiency_dry').should('have.text', '88.49');
    cy.get('#calculation_c_temperature_efficiency_wet').should('have.text', '88.49');
    cy.get('#calculation_c_heat_recovery_dry').should('have.text', '-0.52');
    cy.get('#calculation_c_heat_recovery_wet').should('have.text', '-0.52');
    cy.get('#calculation_c_recovery_of_moisture').should('have.text', '0');
    ...
    cy.get('#calculation_h_output_airflow').should('have.text', '260.97');
    cy.get('#calculation_h_output_temperature').should('have.text', '34.08');
    cy.get('#calculation_h_output_relative_humidity').should('have.text', '30.21');
    cy.get('#calculation_h_output_absolute_humidity').should('have.text', '10.48');
    cy.get('#calculation_h_output_wet_bulb_temperature').should('have.text', '20.79');
    cy.get('#calculation_h_output_enthalpy').should('have.text', '60.28');
    cy.get('#calculation_h_face_air_velocity').should('have.text', '1.13');
    cy.get('#calculation_h_air_pressure_drop').should('have.text', '50.22');
    cy.get('#calculation_h_temperature_efficiency_dry').should('have.text', '88.49');
    cy.get('#calculation_h_temperature_efficiency_wet').should('have.text', '88.49');
    cy.get('#calculation_h_heat_recovery_dry').should('have.text', '0.52');
    cy.get('#calculation_h_heat_recovery_wet').should('have.text', '0.52');
    cy.get('#calculation_h_recovery_of_moisture').should('have.text', '0');
