context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_maximum_heating_power').should('have.text', '4.22');
    cy.get('#calculation_water_pressure_drop').should('have.text', '0.04');
    cy.get('#calculation_water_flow').should('have.text', '0.02');
    cy.get('#calculation_face_air_velocity').should('have.text', '4.59');
    cy.get('#calculation_mass_air_velocity').should('have.text', '5.62');
    cy.get('#calculation_air_pressure_drop').should('have.text', '29.43');
