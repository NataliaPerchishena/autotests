context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_h_output_airflow').should('have.text', '245.15');
    cy.get('#calculation_h_output_temperature').should('have.text', '14.33');
    cy.get('#calculation_h_output_relative_humidity').should('have.text', '45.54');
    cy.get('#calculation_h_output_absolute_humidity').should('have.text', '4.64');
    cy.get('#calculation_h_output_wet_bulb_temperature').should('have.text', '8.64');
    cy.get('#calculation_h_output_enthalpy').should('have.text', '26.22');
    ...
    cy.get('#calculation_h_temperature_efficiency_dry').should('have.text', '56.41');
    cy.get('#calculation_h_temperature_efficiency_wet').should('have.text', '56.41');
    cy.get('#calculation_h_heat_recovery_dry').should('have.text', '0.62');
    cy.get('#calculation_h_heat_recovery_wet').should('have.text', '0.62');
    ...
    cy.get('#calculation_c_output_airflow').should('have.text', '243.73');
    cy.get('#calculation_c_output_temperature').should('have.text', '12.67');
    cy.get('#calculation_c_output_relative_humidity').should('have.text', '58.73');
    cy.get('#calculation_c_output_absolute_humidity').should('have.text', '5.36');
    cy.get('#calculation_c_output_wet_bulb_temperature').should('have.text', '8.69');
    cy.get('#calculation_c_output_enthalpy').should('have.text', '26.33');
    ...
    cy.get('#calculation_c_temperature_efficiency_dry').should('have.text', '56.41');
    cy.get('#calculation_c_temperature_efficiency_wet').should('have.text', '56.41');
    cy.get('#calculation_c_heat_recovery_dry').should('have.text', '-0.62');
    cy.get('#calculation_c_heat_recovery_wet').should('have.text', '-0.62');
    ...
    cy.get('#calculation_c_output_airflow').should('have.text', '259.01');
    cy.get('#calculation_c_output_temperature').should('have.text', '30.58');
    cy.get('#calculation_c_output_relative_humidity').should('have.text', '50.16');
    cy.get('#calculation_c_output_absolute_humidity').should('have.text', '14.14');
    cy.get('#calculation_c_output_wet_bulb_temperature').should('have.text', '22.65');
    cy.get('#calculation_c_output_enthalpy').should('have.text', '67.06');
    ...
    cy.get('#calculation_c_temperature_efficiency_dry').should('have.text', '55.23');
    cy.get('#calculation_c_temperature_efficiency_wet').should('have.text', '55.23');
    cy.get('#calculation_c_heat_recovery_dry').should('have.text', '-0.31');
    cy.get('#calculation_c_heat_recovery_wet').should('have.text', '-0.31');
    cy.get('#calculation_c_condensation').should('have.text', '0');
    ...
    cy.get('#calculation_h_output_airflow').should('have.text', '259.73');
    cy.get('#calculation_h_output_temperature').should('have.text', '31.42');
    cy.get('#calculation_h_output_relative_humidity').should('have.text', '35.35');
    cy.get('#calculation_h_output_absolute_humidity').should('have.text', '10.48');
    cy.get('#calculation_h_output_wet_bulb_temperature').should('have.text', '20.31');
    cy.get('#calculation_h_output_enthalpy').should('have.text', '58.54');
    ...
    cy.get('#calculation_h_temperature_efficiency_dry').should('have.text', '55.23');
    cy.get('#calculation_h_temperature_efficiency_wet').should('have.text', '55.23');
    cy.get('#calculation_h_heat_recovery_dry').should('have.text', '0.31');
    cy.get('#calculation_h_heat_recovery_wet').should('have.text', '0.31');
