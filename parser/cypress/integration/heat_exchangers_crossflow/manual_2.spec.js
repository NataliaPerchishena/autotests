context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_winter_supply_h_output_airflow').should('have.text', '244.96');
    cy.get('#calculation_winter_supply_h_output_temperature').should('have.text', '14.11');
    cy.get('#calculation_winter_supply_h_output_relative_humidity').should('have.text', '47.25');
    cy.get('#calculation_winter_supply_h_output_absolute_humidity').should('have.text', '4.75');
    cy.get('#calculation_winter_supply_h_output_wet_bulb_temperature').should('have.text', '8.63');
    cy.get('#calculation_winter_supply_h_output_enthalpy').should('have.text', '26.16');
    ...
    cy.get('#calculation_winter_supply_h_temperature_efficiency').should('have.text', '54.73');
    cy.get('#calculation_winter_supply_h_humidity_efficiency').should('have.text', '14.62');
    cy.get('#calculation_winter_supply_h_heat_recovery').should('have.text', '0.62');
    ...
    cy.get('#calculation_winter_extract_c_output_airflow').should('have.text', '244.01');
    cy.get('#calculation_winter_extract_c_output_temperature').should('have.text', '12.99');
    cy.get('#calculation_winter_extract_c_output_relative_humidity').should('have.text', '56.34');
    cy.get('#calculation_winter_extract_c_output_absolute_humidity').should('have.text', '5.26');
    cy.get('#calculation_winter_extract_c_output_wet_bulb_temperature').should('have.text', '8.7');
    cy.get('#calculation_winter_extract_c_output_enthalpy').should('have.text', '26.4');
    ...
    cy.get('#calculation_winter_extract_c_temperature_efficiency').should('have.text', '53.89');
    cy.get('#calculation_winter_extract_c_humidity_efficiency').should('have.text', '14.62');
    cy.get('#calculation_winter_extract_c_heat_recovery').should('have.text', '-0.62');
    ...
    cy.get('#calculation_summer_supply_c_output_airflow').should('have.text', '259.8');
    cy.get('#calculation_summer_supply_c_output_temperature').should('have.text', '31.51');
    cy.get('#calculation_summer_supply_c_output_relative_humidity').should('have.text', '45.9');
    cy.get('#calculation_summer_supply_c_output_absolute_humidity').should('have.text', '13.67');
    cy.get('#calculation_summer_supply_c_output_wet_bulb_temperature').should('have.text', '22.58');
    cy.get('#calculation_summer_supply_c_output_enthalpy').should('have.text', '66.82');
    ...
    cy.get('#calculation_summer_supply_c_temperature_efficiency').should('have.text', '43.68');
    cy.get('#calculation_summer_supply_c_humidity_efficiency').should('have.text', '12.84');
    cy.get('#calculation_summer_supply_c_heat_recovery').should('have.text', '-0.4');
    ...
    cy.get('#calculation_summer_extract_h_output_airflow').should('have.text', '259.63');
    cy.get('#calculation_summer_extract_h_output_temperature').should('have.text', '31.3');
    cy.get('#calculation_summer_extract_h_output_relative_humidity').should('have.text', '37.19');
    cy.get('#calculation_summer_extract_h_output_absolute_humidity').should('have.text', '10.95');
    cy.get('#calculation_summer_extract_h_output_wet_bulb_temperature').should('have.text', '20.36');
    cy.get('#calculation_summer_extract_h_output_enthalpy').should('have.text', '58.82');
    ...
    cy.get('#calculation_summer_extract_h_temperature_efficiency').should('have.text', '53.78');
    cy.get('#calculation_summer_extract_h_humidity_efficiency').should('have.text', '12.84');
    cy.get('#calculation_summer_extract_h_heat_recovery').should('have.text', '0.4');
