context('Blauberg', () => {
  ...
  it('manual_selection', () => {
    ...
    cy.get('#calculation_heater_maximum_heating_power').should('have.text', '51.98');
    cy.get('#calculation_heater_water_pressure_drop').should('have.text', '9.95');
    ...
    cy.get('#calculation_cooler_summer_hydraulic_resistance').should('have.text', '0.17');
    cy.get('#calculation_cooler_summer_refrigerating_agent').should('have.text', 'R410A');
    cy.get('#calculation_fans_winter_ia').should('have.text', '1.17');
    cy.get('#calculation_fans_winter_number_of_fans').should('have.text', '1');
    cy.get('#calculation_fans_winter_sfp').should('have.text', '480.53');
