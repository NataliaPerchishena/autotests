context('Blauberg', () => {
  ...
  it('manual_selection', () => {
    ...
    cy.get('[data-cy=title]').should('include.text', 'AV02 CFP 2500-HW-CW-A31');
...
//erp
   ...
   cy.get('#erp_trade_mark_value').should('have.text', 'Vents');
   cy.get('#erp_model_key').should('have.text', 'Model');
   cy.get('#erp_model_value').should('include.text', 'AV02 CFP 2500');
