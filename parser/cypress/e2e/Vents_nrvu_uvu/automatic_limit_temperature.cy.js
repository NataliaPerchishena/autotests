context('Vents', () => {
  ...
  it('temperature_air_main', () => {
    ...
    const id_el = ['#summer_temperature', '#winter_temperature']
  ...
  it('temperature_air_heater_electric', () => {
    ...
    const id_heater_el = ['#supply_heater_electric_temperature_after']
  ...
  it('temperature_air_heater_water', () => {
    ...
    const id_heater_w = ['#supply_heater_water_temperature_after']
  ...
  it('temperature_heater_water', () => {
   ...
   cy.wrap(true_temp).each(($el)=>{
    ...
    cy.wrap(false_temp).each(($el)=>{
      ...
      cy.get('#block_supply_heater').click({ force: true })
      cy.get('#automatic_calculate-submit').should('have.attr', 'disabled')
      cy.get ('#form-errors').should('not.be.empty').find('li').should('exist').and('contain.text','Hot water OUT temperature').and('contain.text' , 'Hot water IN temperature').and('contains.text','temperature must be in');
  })
...
it('temperature_air_cooler_water', () => {
  ...
  const id_heater_el = ['#supply_cooler_water_temperature_after']
  ...
  it('temperature_cooler_water', () => {
   ...
   cy.wrap(true_temp).each(($el)=>{
    ...
    cy.wrap(false_temp).each(($el)=>{
      ...
      cy.get('#block_supply_cooler').click({ force: true })
      cy.get('#automatic_calculate-submit').should('have.attr', 'disabled')
      cy.get ('#form-errors').should('not.be.empty').find('li').should('exist').and('contain.text','OUT temperature').and('contain.text' , 'IN temperature').and('contains.text','temperature must be in');
  })
  cy.wrap(in_out_limit_temp).each(($el)=>{
    cy.get('#supply_cooler').select('water', { force: true })
    cy.get ('#supply_cooler_water_temperature_out').clear().type($el.out);
...
// })
  ...
  it.only('temperature_air_cooler_water_for_heating', () => {
    const temp_true = ['-60', '60']
    const temp_false = ['-60.1', '-61', '60.1', '61']
  ...
  it('temperature_air_cooler_freon', () => {
    ...
    const id_heater_el = ['#supply_cooler_freon_temperature_after']
