context('Blauberg', () => {
  ...
  it('manual_selection', () => {
    ...
    cy.get('.product-sku').should('includes.text', 'Axis-FP 630-4/8D/0.6/0.15-8/25/AL-U1-300/2');
    ...
    cy.get('.selector-dimensions').children('div.table-responsive').find('tbody').find('tr').should('have.length.least', 6);
