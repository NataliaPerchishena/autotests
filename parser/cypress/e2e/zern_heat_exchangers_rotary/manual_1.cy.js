context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#select2-model-container').click().type('R-EX D400-2.1/5.5-0-1 600x600x295{enter}');
    //cy.get('#select2-model-result-n683-R-EX D400-2.1/7-0-1 600x600x295').click();
    ...
    cy.get('#calculation_winter_standard_airflow').should('have.text', '250');
