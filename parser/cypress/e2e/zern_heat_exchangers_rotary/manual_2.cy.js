context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_winter_h_output_temperature').should('have.text', '18.68');
    cy.get('#calculation_winter_h_output_relative_humidity').should('have.text', '34.34');
    ...
    cy.get('#calculation_winter_h_temperature_efficiency_dry').should('have.text', '89.87');
    cy.get('#calculation_winter_h_air_pressure_drop').should('have.text', '45.08');
    cy.get('#calculation_winter_h_heat_recovery_dry').should('have.text', '1');
    ...
    cy.get('#calculation_summer_c_output_temperature').should('have.text', '27.84');
    cy.get('#calculation_summer_c_output_relative_humidity').should('have.text', '59.15');
    ...
    cy.get('#calculation_summer_c_temperature_efficiency_dry').should('have.text', '89.48');
    cy.get('#calculation_summer_c_air_pressure_drop').should('have.text', '49.71');
    cy.get('#calculation_summer_c_heat_recovery_dry').should('have.text', '-0.54');
