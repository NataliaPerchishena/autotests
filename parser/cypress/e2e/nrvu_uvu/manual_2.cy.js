context('Blauberg', () => {
  ...
  it('manual_selection', () => {
    ...
    cy.get('#calculation_heater_maximum_heating_power').should('have.text', '54');
    ...
    cy.get('#calculation_cooler_summer_maximum_cooling_power').should('have.text', '21.57');
    ...
    cy.get('#calculation_cooler_summer_water_pressure_drop').should('have.text', '0.27');
    cy.get('#calculation_cooler_summer_air_pressure_drop').should('have.text', '8.62');
    cy.get('#calculation_cooler_summer_face_air_velocity').should('have.text', '0.68');
    cy.get('#calculation_fans_winter_ia').should('have.text', '0.48');
    cy.get('#calculation_fans_winter_number_of_fans').should('have.text', '1');
    cy.get('#calculation_fans_winter_sfp').should('have.text', '548.41');
