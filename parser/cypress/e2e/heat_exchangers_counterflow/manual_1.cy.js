context('Blauberg', () => {
  ...
  it('calculate_button', () => {
    ...
    cy.get('#calculation_winter_h_output_relative_humidity').should('have.text', '36.11');
    cy.get('#calculation_winter_h_face_air_velocity').should('have.text', '0.96');
    cy.get('#calculation_winter_h_condensation').should('have.text', '0');
    cy.get('#calculation_winter_h_temperature_efficiency_dry').should('have.text', '83.85');
    cy.get('#calculation_winter_h_air_pressure_drop').should('have.text', '68.52');
    cy.get('#calculation_winter_h_heat_recovery_dry').should('have.text', '0.92');
    ...
    cy.get('#calculation_summer_c_output_temperature').should('have.text', '28.31');
    cy.get('#calculation_summer_c_output_relative_humidity').should('have.text', '57.48');
    cy.get('#calculation_summer_c_face_air_velocity').should('have.text', '1.06');
    cy.get('#calculation_summer_c_condensation').should('have.text', '0');
    cy.get('#calculation_summer_c_temperature_efficiency_dry').should('have.text', '83.58');
    cy.get('#calculation_summer_c_air_pressure_drop').should('have.text', '77.55');
    cy.get('#calculation_summer_c_heat_recovery_dry').should('have.text', '-0.49');
