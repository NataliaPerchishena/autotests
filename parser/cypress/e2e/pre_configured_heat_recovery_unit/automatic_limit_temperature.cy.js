context('Blauberg', () => {
  ...
  it('temperature_heater_water', () => {
   ...
   cy.wrap(true_temp).each(($el)=>{
        ...
        cy.get('#pre_configured_heat_recovery_unit_supply_heater').click({ force: true })
...
//   })
  ...
  it.only('temperature_cooler_water', () => {
   ...
   cy.wrap(true_temp).each(($el)=>{
        ...
        cy.get('#pre_configured_heat_recovery_unit_supply_cooler').click({ force: true })
        cy.get('#automatic_calculate-submit').should('not.have.attr', 'disabled')
...
cy.wrap(in_out_limit_temp).each(($el)=>{
  ...
  cy.get('#supply_cooler').select('water', { force: true })
  cy.get ('#supply_cooler_water_temperature_after').clear().type('15');
  ...
  it('temperature_cooler_water_for_heating', () => {
   ...
   cy.wrap(true_temp).each(($el)=>{
        ...
        cy.get('#pre_configured_heat_recovery_unit_supply_cooler_for_heating').click({ force: true })
        cy.get('#automatic_calculate-submit').should('not.have.attr', 'disabled')
